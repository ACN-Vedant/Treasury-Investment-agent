...
Go to [claude.ai](https://claude.ai) and click **New chat**. Do not continue in the same chat as Step 1 — start fresh.
...
```
MARKET RATES & POLICY:
Rate_Date	01/06/2026
Overnight_Rate	5.10%
1_Month_Rate	5.20%
3_Month_Rate	5.28%
6_Month_Rate	5.35%
Min_Acceptable_Yield	4.80%
Max_Tenor_Days	180
Min_Credit_Rating	A-
Approved_Products	Fixed Deposit; T-Bill; Money Market Fund; Commercial Paper
Approved_Counterparties	Barclays; HSBC; JPMorgan; Citibank; Deutsche Bank; BNP Paribas; NatWest; Wells Fargo; BlackRock MMF
Max_Counterparty_Limit_Barclays	20000000
Max_Counterparty_Limit_HSBC	20000000
Max_Counterparty_Limit_JPMorgan	25000000
```
...
```
=== STEP 2 OUTPUT — COMPLIANCE SUB-AGENT ===
[paste JSON here]
```
...
**→ [Step 3 — Ratings Sub-Agent](03_ratings_agent.md)**

---

*Source: Treasury Investment AI Agent Implementation Guide — Section 4.2 (Compliance Sub-Agent — v3 Policy-Only)*
